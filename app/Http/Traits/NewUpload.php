...
trait NewUpload
{
	...
	public function getUploadAttribute($key)
	{
		...
		if ($this->isUploadField($key)) {
			...
			$value = $this->getUploadAttribute($originalKey);
		...
		return parent::getUploadAttribute($key);
	}
	...
	protected function mutateAttribute($key, $value)
	{
		...
		if ($this->isUploadField($key)) {
			return $this->getUploadAttribute($key);
		}
	 ...
	 * @return $this
	 */
	public function setUploadedAttribute($key, $value)
	{
		$this->findUploadFields();
		...
		return parent::setUploadedAttribute($key, $value);
	}
