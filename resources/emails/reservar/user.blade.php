...
<body style="margin:0; padding:0; font-size:14px; line-height:18px; font-family:'Trebuchet MS', Verdana, sans-serif; min-width:320px !important;" bgcolor="#f6f6f6" link="#535353">
							...
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td class="intro" style="font-size:16px; line-height:20px; color:#000000; padding-top:30px; padding-bottom:30px; border-bottom:1px solid #cccccc;">
										<strong style="display:block; font-weight:bold;">Hola {{ $user['first_name'] }} {{ $user['last_name'] }}</strong>, muchas gracias por reservar con Kipmuving. Sigue abajo la confirmación de su reserva.<br><br>
										<p>¿Qué haremos ahora? Vamos a confirmar todos los paseos con las agencias. Sabemos que algunas están sujetas a disponibilidad por la cantidad de personas y también del clima. Caso alguna actividad no suceda, volveremos a comunicar contigo para ofrecer otra opción. <br><br></p>
										...
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td style="padding-bottom:20px;" colspan="2">
													<table cellpadding="0" cellspacing="0" width="100%">
														<tr>
															<td width="51" height="39" valign="middle" style="font-size:0; line-height:0; padding-right:20px;"><img src="{{ url($offer['offer']['activity_icon']) }}" alt="activity image" align="left" vspace="0" hspace="0"></td>
															<td>
																<h2 style="margin-top:0; margin-bottom:0;"><span style="font-size:31px; line-height:35px; color:#089f02;">{{ $offer['offer']['activity_name'] }}</span></h2>
																<strong style="font-size:22px; line-height:26px; font-weight:bold; display:block;">{{ $offer['offer']['agency_name'] }}</strong>
															</td>
														</tr>
													</table>
												</td>
											...
											<tr>
												<td style="width:50%; padding-bottom:20px;" valign="top">
													<strong style="display:block; font-weight:bold; padding-left:10px;">Debes llevar:</strong>
                          <p>{{ $offer['offer']['carry'] }}</p>
												</td>
												<td style="width:50%; padding-bottom:20px;" valign="top">
													...
													<span style="display:block; margin-left:25px;"><strong>Duracion:</strong> {{ max(0, $offer['offer']['end_hour'] - $offer['offer']['start_hour']) }} hrs</span>
											...
											<tr>
												<td colspan="2" bgcolor="#913b49" style="padding-top:10px; padding-right:20px; padding-bottom:10px; padding-left:40px; color:#ffffff; background:url(ico3.png) no-repeat; background-color:#913b49; background-position:10px 14px;">
													<strong style="display:block; font-size:16px; line-height:20px; font-weight:bold;">Importante:</strong>
                ...
                @endforeach
					...
					<tr>
						<td id="footer" valign="top" style="padding-left:20px; padding-top:20px; padding-right:20px; padding-bottom:20px;">
							Total a pagar en la agencia es de <span style="color:#980e25; font-weight:bold;">$ {{ $total_cost }} pesos.</span> Cada agencia tiene su política de cancelación, esté atento a ellas en el momento de su reserva. Pero normalmente puedes cancelar hasta 1 día antes de su actividad. En este caso, te devolveremos los 10% cancelado.
							<br>
							<br>
							Caso no apareazca en el día de su aventura, será cobrado un valor de <span style="color:#980e25; font-weight:bold;">10% como multa.</span>
							<br>
							<br>
