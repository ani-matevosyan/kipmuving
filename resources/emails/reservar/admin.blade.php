			...
			<tr>
				...
				<!--[if gte mso 9]><table align="center" border="0" cellspacing="0" cellpadding="0" width="600" style="width:600px;"><tr><td align="center" valign="top" width="600" style="width:600px;"><![endif]-->
					<table border="0" cellpadding="0" cellspacing="0" width="100%" style="width: 600px !important;">
						<tr>
							<td valign="top"  style="background-color: #133939;	border-top: 0; border-bottom: 0; padding-top: 9px; padding-bottom: 9px;">
												...
												<table style="min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
													<tbody>
														<tr>
															...
															font-size: 12px;
															line-height: 150%;
															text-align: left; padding: 9px 18px;color: #000000;font-family: &quot;trebuchet ms&quot: ;,&quot: ;lucida grande&quot: ;lucida sans unicode&quot: ;lucida sans&quot: ;,tahoma,sans-serif: ;font-size: 14px;font-style: normal;font-weight: normal;" valign="top">
																<br>
																<strong>Hola Administrator</strong><br>
																tenemos <span style="color:#980e25">{{ count($admin_reservations) }} paseos</span> para <span style="color:#980e25">1 persona.</span><br>&nbsp;
															</td>
														</tr>
													</tbody>
												</table>
										...
										<tr>
											<td class="mcnTextBlockInner" valign="top">
												<table style="min-width:100%;" class="mcnTextContentContainer" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
													<tbody>
														<tr>
															<td class="mcnTextContent" style="padding: 9px 18px; font-family: &quot;Trebuchet MS&quot;,&quot;Lucida Grande&quot;,&quot;Lucida Sans Unicode&quot;,&quot;Lucida Sans&quot;,Tahoma,sans-serif; font-style: normal; font-weight: normal; line-height: 150%;" valign="top">
																<?php $total_price = 0; ?>
																@foreach ($admin_reservations as $reservation)
																<?php $total_price += $reservation['persona'] * $reservation['price']; ?>
																<h2><span style="color:#008000"><span style="font-size:24px; line-height:22px">{{ $reservation['activity_name'] }}</span></span></h2>
																<span style="font-size:14px">Date: {{ $reservation['reserve_date'] }}</span><br>
																&nbsp;
																<address style="font-style:normal">
																<strong>Agency Information</strong><br>
																Name: {{ $reservation['agency_name'] }}<br>
																Email: {{ $reservation['agency_email'] }}<br>
																</address>
																<br>
																<address style="font-style:normal">
																<strong>Guest Information</strong><br>
																Name: {{ $reservation['guest_name'] }}<br>
																Email: <a href="#" style="color:#000; text-decoration:none;"><span>{{ $reservation['guest_email'] }}</span></a><br>
																Persona: {{ $reservation['persona'] }}<br>
																Price: {{ $reservation['price'] }}<br>
																&nbsp;
																</address>
																@endforeach
																<span style="color:#980e25"><span style="font-size:16px"><strong>Total a pagar de ${{ $total_price }}</strong></span></span>
															</td>
														</tr>
													</tbody>
												</table>
