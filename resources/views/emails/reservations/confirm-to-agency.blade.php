                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td style="border-bottom: 1px solid #e0e0e0; padding-top: 18px; padding-bottom: 20px;">
                                            ...
                                            <p style="margin: 20px 0 0 0;"><strong>{{ trans('emails.guests_information') }}</strong></p>
                                            <p style="margin: 0 0 0 0"><strong>{{ trans('form.name') }}</strong>: KALINKA MALINKA</p>
                                            <p style="margin: 0 0 0 0"><strong>{{ trans('form.email') }}</strong>: <a href="#" style="color: #191919; text-decoration: none;">kkrenz.856478@guest.booking.com</a></p>
                                            <p style="margin: 0 0 0 0"><strong>{{ trans('emails.phone_number') }}</strong>: 51 82877000</p>
