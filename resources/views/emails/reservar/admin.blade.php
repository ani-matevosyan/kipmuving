...
{{--<body style="min-width: 320px !important;">--}}
<center>
											...
											<tbody>
												<tr>
													<td class="mcnImageContent" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0;" valign="top">
														<a href="/">
															<img alt="" src="{{ url('/images/aventuraschile_logo.png') }}" style="max-width:180px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" align="left" width="340">
														</a>
													</td>
												</tr>
											</tbody>
								...
								<tr>
									<td class="mcnTextBlockInner" valign="top">
										<table style="min-width:100%;" class="mcnTextContentContainer" align="left" border="0"
											...
											<tbody>
											<tr>
												<td style="font-family: Helvetica; line-height: 150%;
															text-align: left; padding: 0px 35px;color: #000000;font-style: normal;font-weight: normal;"
													 valign="top">
													<hr>
													<br>
					...
					<tr>
						<td valign="top" id="templateBody">
							<table class="mcnTextBlock" style="min-width:100%;" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									<td class="mcnTextBlockInner" valign="top">
										<table style="min-width:100%; font-size: 15px" class="mcnTextContentContainer" align="left" border="0"
												 cellpadding="0" cellspacing="0" width="100%">
											<tbody>
											<tr>
												<td class="mcnTextContent"
													 style="padding: 9px 35px; font-family: &quot;Trebuchet MS&quot;,&quot;Lucida Grande&quot;,&quot;Lucida Sans Unicode&quot;,&quot;Lucida Sans&quot;,Tahoma,sans-serif; font-style: normal; font-weight: normal; line-height: 150%;"
													 valign="top">
													@foreach ($reservation->offers as $offer)
														<h2 style="font-size:31px; line-height:22px; color:#198ccd;">
															{{ $offer->activity->name }}
														</h2>
														 <b>{{ $offer->agency->name }}<br></b>
													...
													@endforeach
													<div style="color:#980e25; margin-bottom: 15px"><span style="font-size:16px"><strong>Total a pagar de ${{ $reservation->total['CLP'] }} CLP</strong></span></div>
													<hr>
													<p style="margin-top: 40px">
														Cras pharetra justo sit amet quam pellentesque, a laoreet orci placerat. Sed sollic
														itudin dui ut fermentum hendrerit. Ut mattis odio sapien, eu iaculis velit suscipit e
