			...
			<table style="margin:0 auto; width: auto !important; max-width:600px !important; background: #f6f6f6;" cellpadding="0"
						...
						<table cellpadding="0" cellspacing="0">
							<tr>
								<td style="font-size:16px; line-height:20px; color:#000000; padding-top:55px; padding-bottom:16px; border-bottom:1px solid #cccccc;">
									...
									<strong style="display:block; font-weight:bold; margin-top: 25px;">{{ trans('emails.activities_you_booked') }}:</strong>
								</td>
							</tr>
												...
												<td style="width:50%; padding-bottom:20px;" valign="top">
                                                    <ul class="timing">
                                                        ...
                                                        <li class="money">
                                                            ...
                                                            <strong class="title">$ 270.000</strong>
                                                        </li>
                                                    </ul>
												</td>
											</tr>
				...
				<tr>
					<td id="footer" class="footer">
                        ...
                        <strong style="color:#980e25; font-weight:bold;">$ {{ $reservation->total->with_discount['CLP'] }} CLP
							.</strong>{{ trans('emails.must_be_paid_at_agency') }}</p>
