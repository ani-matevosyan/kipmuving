...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr style="padding: 10px 0 30px 0;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
            <tbody>
            <tr>
                <td align="left" bgcolor="#383838" style="padding: 7px 10px 6px 38px; color: #FFCD06; font-size: 40px;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <td style="border-bottom: 1px solid #e0e0e0; padding-top: 18px; padding-bottom: 20px;">
                                            <h2 style="font-weight: 700; font-size: 26px; color: #323e5b; margin: 0 0 3px 0;">Volcán Villarrica</h2>
                                            ...
                                            <p style="margin: 0 0 0 0"><strong>{{ trans('emails.your_price') }}</strong>: $ 120.000</p>
                                            <p style="margin: 0 0 0 0"><strong>{{ trans('emails.original_price') }}</strong>: $ 360.000</p>
                                            <p style="margin: 19px 0 0 0"><strong>{{ trans('main.agency') }}</strong>: <strong style="color: #3097d2">Aguaventura</strong></p>
                                            <p style="margin: 0 0 0 0"><strong>{{ trans('emails.offer_price') }}</strong>: <strong style="color: #3097d2">$120.000</strong></p>
                                            <p style="margin: 0 0 0 0">{{ trans('emails.offer_valid') }}: 17/12/2017</p>
                                            <a href="#" style="font-size: 14px; color: #ffffff; text-transform: uppercase; font-weight: 700; background: #198ccd; border-radius: 4px; display: inline-block; text-decoration: none; padding: 5px 14px 5px 14px; margin-top: 31px;">{{ trans('emails.go_to_my_offers') }}</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="border-bottom: 1px solid #e0e0e0; padding-top: 18px; padding-bottom: 20px;">
