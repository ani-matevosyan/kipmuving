                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="border-bottom: 1px solid #e0e0e0; padding-bottom: 16px;">
                                                <p style="margin: 0 0 0 0">{{ trans('emails.hello') }} <strong>Agency Name,</strong></p>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="border-bottom: 1px solid #e0e0e0; padding-top: 18px; padding-bottom: 20px;">
                                                                ...
                                                                <p style="margin: 0 0 0 0"><strong>{{ trans('main.total') }}</strong>: $ 360.000</p>
                                                                <a href="#" style="font-size: 14px; color: #ffffff; text-transform: uppercase; font-weight: 700; background: #198ccd; border-radius: 4px; display: inline-block; text-decoration: none; padding: 5px 14px 5px 14px; margin-top: 31px;">{{ trans('main.send_special_offer') }}</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="border-bottom: 1px solid #e0e0e0; padding-top: 18px; padding-bottom: 20px;">
