	...
	<main>
		...
		<section class="routes-activity">
			<div class="container">
				...
				@if($free_activity->instagram_location_id || $free_activity->instagram_id)
					<div class="routes-activity__instagram-block">
						@if(is_null($free_activity->instagram_location_id) && $free_activity->instagram_id)
							<header>#{{ $free_activity->instagram_id }}</header>
						@endif
						<div class="routes-activity__instagram routes-activity__instagram_loading"
								 id="routes-activity-instagram"
								 @if($free_activity->instagram_location_id) data-location-id="{{ $free_activity->instagram_location_id }}" @endif
								 data-tag="{{ $free_activity->instagram_id }}"></div>
					</div>
				@endif
				<div class="routes-activity__tripadvisor-block">
					...
					@endif
					<script
							src="https://www.jscache.com/wejs?wtype=selfserveprop&amp;uniq=883&amp;locationId=2069432&amp;lang=ru&amp;rating=true&amp;nreviews=5&amp;writereviewlink=true&amp;popIdx=true&amp;iswide=false&amp;border=false&amp;display_version=2"></script>
				</div>
			</div>
		</section>
