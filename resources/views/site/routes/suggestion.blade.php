										...
										<ul class="days-list__activity-list">
											@foreach($day->activities->sortBy('order_') as $item)
												<li>
													...
													@if($item->activity->instagram_location_id || ($item->activity_type == 'free' ? $item->activity->instagram_id : $item->activity->instagram_name))
													<div class="days-list__instagram-block days-list__instagram-block_loading"
															 id="instagram{{ $item->activity_id }}"
															 @if($item->activity->instagram_location_id) data-location-id="{{ $item->activity->instagram_location_id }}" @endif
															 data-tag="{{ $item->activity_type == 'free' ? $item->activity->instagram_id : $item->activity->instagram_name }}"></div>
													@endif
													<footer>
