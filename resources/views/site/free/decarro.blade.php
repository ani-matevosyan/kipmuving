...
@section('subpage')
	<div id="m-box-3">
		...
		<div class="guide-places-plates-wrapper">
			@if(count($activities->where('page', '=', 'bus')->where('category', '=', 'Visual')) > 0)
				<h2>Visual</h2>
			...
			@endif
			@if(count($activities->where('page', '=', 'bus')->where('category', '=', 'Caminatas')) > 0)
				<h2>Caminatas</h2>
				<div class="guide-places-plates">
			...
			@endif
			@if(count($activities->where('page', '=', 'bus')->where('category', '=', 'Termas')) > 0)
				<h2>Termas</h2>
				<div class="guide-places-plates">
