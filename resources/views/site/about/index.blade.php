        ...
        <section class="s_about_page">
            <div class="container">
                <div class="about_content">
                    <p><strong>KipMuving</strong> surgió de la necesidad de ofrecer al visitante de Pucón, mejores opción de elección de la agencia de turismo y
                        también ampliar sus posibilidades de paseos en la ciudad. Por medio de convenios con las agencias, podemos beneficios:
                    </p>
                    <ul>
                        <li>
                    ...
                    <p>Así <strong>KipMuving</strong> urge para suplir una necesidad del sector de aventuras, donde el usuario
                        tiene más opciones y las agencias más visibilidad.  Y el usuario apenas colabora con 3% del valor total de sus actividades. Esto sirve para cubrir gastos y seguir mejorando la aplicación web.</p>
                    ...
                    <p class="credits">Créditos: <a target="_blank" href="http://flaticon.com/">http://flaticon.com/</a></p>
                </div>
            </div>
        </section>
    </main>
