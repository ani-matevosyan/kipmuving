...
@section('content')
    <main>
        <div class="container">
            ...
            <p>Aventuras Chile operates the <a href="{{ asset('/') }}">{{ asset('/') }}</a> website, which provides the SERVICE.</p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at https://aventuraschile.com/ , unless otherwise defined in this Privacy Policy.</p>
