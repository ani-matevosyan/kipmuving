							...
							@foreach ($reservation->offers as $offer)
								<li class="chosen-offers-list__item">
									...
									<div class="chosen-offers-list__information">
										...
										<span class="chosen-offers-list__price"><small class="chosen-offers-list__currency-sign">@if(session('currency.type') === 'BRL') R$ @else
													$ @endif</small> {{ number_format($offer->reservation['persons'] * $offer->price, 0, '.', '.') }}</span>
									</div>
							...
							@foreach ($reservation->offers as $offer)
								<li class="chosen-offers-list__item chosen-offers-list__item_special">
									...
									<div class="chosen-offers-list__information chosen-offers-list__information_special">
										<p class="chosen-offers-list__request-sent">{{ trans('main.we_send_this') }}<strong>20 {{ trans('main.agencies') }}</strong></p>
										<div class="chosen-offers-list__order-information">
											<ul class="order-information-list">
