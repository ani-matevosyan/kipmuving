...
{{-- Content --}}
@section('content')
<section class="visual activity-single" @if ($activity->image) style="background-image: url('/{{ $activity->image }}')" @endif>
</section>
				...
				<div class="your-reservation activity add new">
					...
					<div class="row">
						<div id="activity-single-sidebar" class="col-md-4 col-sm-12 col-xs-12" >
							@include('site.activities.activity-single-sidebar', array($dt))
						</div>
							...
							<section class="post-box">
								<div class="title-box">
									...
									<div class="weather-box">
										...
										<p>Esta atividad está sujeta al clima. Si llueve, muchas nubes o viento, la actividad no se realiza. Puedes percibir como estará el clima en una semana para que te programe cual es el mejor día para hacer esta actividad. Eliga de preferencia un dia que tenga sol.</p>
										{{ $activity->weather_embed }}
									</div>
									@endif
									<nav class="subnav">
										<div class="date-time">
											<div class="text-field"><a href="#" class="overlay-opener"><input id="reserve-date" type="text" data-datepicker='{"firstDay": 1, "minDate": 1, "dateFormat": "dd/mm/yy" }' placeholder="" value="{{ $dt }}"></input></a></div>
										</div>
										<ul role="tablist">
											<li>Ordenar por</li>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="tab2">
										<ul class="accordion">
											@foreach ($offers_recommendation as $offer)
