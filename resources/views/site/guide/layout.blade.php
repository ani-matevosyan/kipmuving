        ...
        <nav class="guide-navigation">
            <div class="container">
                ...
                <ul class="guide-navigation__list">
                    ...
                    <li class="guide-navigation__item">
                        <a href="{{ action('GuideController@nightLife') }}" class="guide-navigation__link">
                            <img src="{{ asset('/images/guide-icon8.png') }}" alt="Night life" class="guide-navigation__icon">
                            Vida noturna
                        </a>
                    </li>
                    <li class="guide-navigation__item">
                        <a href="{{ action('GuideController@cityAndZones') }}" class="guide-navigation__link">
                            <img src="{{ asset('/images/guide-icon3.png') }}" alt="City and Zones" class="guide-navigation__icon">
                            Ciudad y Zonas
                        </a>
                    </li>
                    <li class="guide-navigation__item">
                        <a href="{{ action('GuideController@whatToEat') }}" class="guide-navigation__link">
                            <img src="{{ asset('/images/guide-icon6.png') }}" alt="What to eat" class="guide-navigation__icon">
                            Que comer
                        </a>
                    </li>
                    <li class="guide-navigation__item">
                        <a href="{{ action('GuideController@money') }}" class="guide-navigation__link">
