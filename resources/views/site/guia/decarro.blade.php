...
<div class="row">
    <div class="col-sm-7">
        <div class="left-col">
            <div class="map-tab active" id="map-tab-d28815fcb5bd85363824673e2de45b66">
                <div class="termas">
                    <div class="row">
            ...
            <div class="map-tab" id="map-tab-8d4f863ecf786eb49604ddbd1e25547e">
                <div class="termas">
                    <div class="row">
                        <div class="col-sm-6 col-xs-12">
                            <h2>Termas Peumayen</h2>
                        </div>
                        <div class="col-sm-6 mobile-left col-xs-12">
                            <div class="pull-right">
                                <div class="opiniones">
                                    <div id="TA_selfserveprop748" class="TA_selfserveprop">
                                        <ul id="8cqAAN" class="TA_links 5VpfIX7">
                                            <li id="qHirytPfkZtA" class="uAvPh6yCdHxU">
                                    ...
                                    <script src="https://www.jscache.com/wejs?wtype=selfserveprop&amp;uniq=748&amp;locationId=2145917&amp;lang=es&amp;rating=true&amp;nreviews=0&amp;writereviewlink=false&amp;popIdx=false&amp;iswide=false&amp;border=false&amp;display_version=2"></script>
                                </div>
                            </div>
                        </div>
                    </div>
