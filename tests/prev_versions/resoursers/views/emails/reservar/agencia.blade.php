        ...
        <tr>
            <td align="center" valign="top" id="bodyCell">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="width: 600px !important;">
                    <tr>
                        <td valign="top"
                            style="background-color: #133939;	border-top: 0; border-bottom: 0; padding: 15px;">
                                        ...
                                        <table class="mcnImageContentContainer" style="min-width:100%;" align="left" border="0"
                                            ...
                                            <tr>
                                                <td class="mcnImageContent" valign="top">
                                                    <a href="/">
                                                        <img alt="" src="{{ url('/images/logo-new.svg') }}"
                                                             style="width:207px; padding-bottom: 0; display: inline !important; vertical-align: bottom;"
                                                             class="mcnImage" align="left"></td>
                                                </a>
                                            </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table style="min-width:100%;" class="mcnTextContentContainer" align="left" border="0"
                                            ...
                                            <tr>
                                                <td class="mcnTextContent"
                                                    style="padding: 9px 18px; font-style: normal; font-weight: normal; line-height: 150%;"
                                                    valign="top">
                                                    <!--?php $total = 0; ?-->
